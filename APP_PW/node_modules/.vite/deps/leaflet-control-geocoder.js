...
var s = __toESM(require_leaflet_src());
var N = Object.defineProperty;
var M = (a, t, n) => t in a ? N(a, t, { enumerable: true, configurable: true, writable: true, value: n }) : a[t] = n;
...
var b = class extends _ {
  ...
  _createAlt(n, e) {
    const o = s.DomUtil.create("li", ""), i = s.DomUtil.create("a", "", o), r = this.options.showResultIcons && n.icon ? s.DomUtil.create("img", "", i) : null, l = n.html ? void 0 : document.createTextNode(n.name), c = (g) => {
      this._preventBlurCollapse = true, s.DomEvent.stop(g), this._geocodeResultSelected(n), s.DomEvent.on(o, "click touchend", () => {
  ...
  _change() {
    ...
    n !== this._lastGeocode && (clearTimeout(this._suggestTimeout), n.length >= this.options.suggestMinLength ? this._suggestTimeout = setTimeout(() => this._geocode(true), this.options.suggestTimeout) : this._clearResults());
  }
};
function pt(a) {
  return new b(a);
